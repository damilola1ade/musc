...
function Blog() {
    return (
        <section id="blog">
            <div className='w-full text-black text-center pt-10 max-w-[1240px] mx-auto px-4 mt-5 overflow-hidden'>
            <h1 className='h2 mb-3 mt-5'>A lot is happening <br/>And we're blogging about it</h1>
        </div>
            <div data-aos='fade-down' className="2xl:mx-auto 2xl:container xl:px-20 lg:px-10 px-6 py-5">
                <div className="lg:flex justify-center">
                    <div className="2xl:w-7/12 lg:w-8/12 md:w-10/12">
                        <img src="https://i.ibb.co/ZY43FRd/blog-1-desktop.png" alt="fingerprint recognition" className="lg:w-full w-auto rounded-3xl" />
                        <div className="mt-4">
                    ...
                    <div className="lg:ml-6 lg:mt-0 mt-7 2xl:w-3/12 lg:w-4/12 w-full flex lg:flex-col sm:flex-row flex-col items-center justify-between">
                        <div className="lg:w-auto sm:w-1/2">
                            <img src="https://i.ibb.co/d6jQJyY/blog-2-desktop.png" alt="flying letters" className="w-full rounded-3xl" />
                            <div className="mt-4">
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center">
                                        <p className="text-base leading-4 text-gray-500">5 feb</p>
                        ...
                        <div className="lg:mt-6 sm:mt-0 mt-6 lg:ml-0 sm:ml-6 lg:w-auto sm:w-1/2">
                            <img src="https://i.ibb.co/9cN11LT/blog-3-desktop.png" alt="robotic arm" className="w-full rounded-3xl" />
                            <div className="mt-4">
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center">
                                        <p className="text-base leading-4 text-gray-500">5 feb</p>
