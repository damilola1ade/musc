...
function Stats() {
  return (
    <section id='stats'>
        <div data-aos="fade-down" className="dark:bg-gray-900">
      <div className="pb-5">
        <div className="mx-auto bg-gradient-to-l from-cyan-500 to-cyan-700 h-96">
          <div className="mx-auto container w-full flex flex-col justify-center items-center">
            <div className="flex justify-center items-center flex-col">
              <div className="mt-20">
                <h2 className="lg:text-4xl md:text-5xl text-4xl font-black leading-10 text-white">By the numbers</h2>
              </div>
        ...
        <div className="mx-auto container md:-mt-28 -mt-40 flex justify-center items-center">
          <div className="grid lg:grid-cols-4 md:grid-cols-2 grid-cols-2 gap-x-2 gap-y-2 lg:gap-x-6 md:gap-x-6 md:gap-y-6 md:gap-y-6">
            ...
            <div className="flex justify-center flex-col items-center w-36 h-36 md:w-44 md:h-48 lg:w-56 lg:h-56 bg-white shadow rounded-2xl">
              <h2 className="lg:text-5xl md:text-4xl text-2xl font-extrabold leading-10 text-center text-gray-800">50</h2>
