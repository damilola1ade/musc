      ...
      <div className="max-w-6xl mx-auto px-7 sm:px-9 mt-2">
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          <nav className="flex flex-row">
            ...
            <li>
                <a href ="#about" className="font-medium text-gray-600 hover:text-gray-900 px-5 py-3 flex items-center transition duration-150 ease-in-out">About Us</a>
              </li>
            <li>
                <a href="#services" className="font-medium text-gray-600 hover:text-gray-900 px-5 py-3 flex items-center transition duration-150 ease-in-out">Our Services</a>
              </li>

            <li>
                <a href="#blog" className="font-medium text-gray-600 hover:text-gray-900 px-5 py-3 flex items-center transition duration-150 ease-in-out">Blog</a>
              </li>
            <li>
                <a href="#contact" className="hidden md:flex pr-4 btn-sm text-gray-200 bg-gray-900 hover:bg-gray-800 ml-3">
