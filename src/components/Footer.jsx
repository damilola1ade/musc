...
function Footer() {
  return (
    <footer>
      <div data-aos='fade-down' data-aos-duration='500' className='relative max-w-6xl mx-auto px-4 sm:px-6 overflow-hidden'>
        ...
        <div className='grid sm:grid-cols-12 gap-8 py-8 md:py-12 border-t border-gray-200'>
          ...
          <div className='sm:col-span-12 lg:col-span-3'>
            <div className='mb-2'>
              ...
              <img src={logo} alt='logo' className='mt-5 sm:mt-5 ml-14 lg:mt-1' width='250' height='96' />
              </Link>
            </div>
