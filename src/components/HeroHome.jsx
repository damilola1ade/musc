      ...
      <div className='max-w-6xl mx-auto px-4 sm:px-6'>
        ...
        <div className='pt-32 pb-12 md:pt-40 md:pb-20'>
          ...
          <div className='text-center pb-12 md:pb-16'>
            <h1 className='text-5xl md:text-6xl font-extrabold leading-tighter tracking-tighter mb-4' data-aos='zoom-y-out'> <span className='bg-clip-text text-transparent bg-gradient-to-r from-blue-500 to-teal-400'>MUSC Ltd</span></h1>
            <div className='max-w-3xl mx-auto'>
              ...
              <div className='max-w-xs mx-auto sm:max-w-none sm:flex sm:justify-center' data-aos='zoom-y-out' data-aos-delay='300'>
                <div>
                  <a className='btn text-white bg-cyan-600 hover:bg-cyan-700 w-full mb-4 sm:w-auto sm:mb-0' href='contact'> Contact Us</a>
                </div>
                <div>
                  <a className='btn text-white bg-gray-900 hover:bg-gray-800 w-full sm:w-auto sm:ml-4' href='team'>Meet The Team</a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <Modal id='modal' ariaLabel='modal-headline' show={videoModalOpen} handleClose={() => setVideoModalOpen(false)}>
              <div className='relative pb-9/16'>
                <iframe className='absolute w-full h-full' src='https://www.youtube.com/embed/gXRWiQanMRI' title='Video' allowFullScreen frameborder='0' allow='accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture' allowfullscreen></iframe>
              </div>
            </Modal>
