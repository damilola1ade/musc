...
function FeaturesBlocks() {
  return (
    <section data-aos='fade-right' data-aos-duration='700' className='relative overflow-hidden'>
       {/*  Site header */}
		 <Header />
      ...
      <div className='relative max-w-6xl mx-auto px-4 sm:px-6'>
        <div className='py-12 md:py-20'>
          ...
          {/* Items */}
          <div data-aos='fade-left' className='max-w-sm mx-auto grid gap-6 md:grid-cols-2 lg:grid-cols-3 items-start md:max-w-2xl lg:max-w-none'>
