...
function Header() {
  ...
  return (
    <header className={`fixed w-full h-30 z-30 md:bg-opacity-90 transition duration-300 ease-in-out ${!top && 'bg-white backdrop-blur-sm shadow-lg'}`}>
        ...
        <div className='flex items-center justify-between h-16 md:h-20'>
          ...
          <div className='flex-shrink-0 mr-4'>
            ...
            <Link to='/' className='block' aria-label='Cruip'>
              <img src={logo} alt='logo' className='mt-3 lg:mt-1' width='150' height='96' />
            </Link>
          </div>
